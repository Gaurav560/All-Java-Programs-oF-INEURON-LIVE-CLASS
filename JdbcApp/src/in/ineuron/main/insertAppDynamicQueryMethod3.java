...
public class insertAppDynamicQueryMethod3 {
...
String sqlInsertDynamicQuery=String.format("insert into studentinfo(`name`,`pnumber`,`age`) values('%s','%s','%d')",name,pnumber,age);
